...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Debe devolver http 400 cuando la request no tenga datos")
    @WithMockUser
    void reservar_escenario() throws Exception {
    ...
    @Test
    @DisplayName("Debe devolver http 200 cuando la request reciba un json valido")
    @WithMockUser
    void reservar_escenario2() throws Exception {
        ...
        var response = mockMvc.perform(post("/consultas")
                        ...
                        .content(datosReservaConsultaJson.write(new DatosReservaConsulta(2L, 5L, fecha, especialidad)).getJson()))
                .andReturn().getResponse();
